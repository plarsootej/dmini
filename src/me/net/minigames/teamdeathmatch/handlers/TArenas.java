...
import me.net.minigames.teamdeathmatch.methods.TCountdown;
...
public class TArenas {
	
	public MainClass plugin;
	protected TeamDeathMatchMain TeamDeathMatchMain;
	public TPlayerHandler arenaph;
	public TCountdown TCountDown;

	public TArenas(String name, MainClass plugin, TeamDeathMatchMain Teamdeathmatchmain) {
		arenaname = name;
		this.plugin = plugin;
		this.TeamDeathMatchMain = Teamdeathmatchmain;
		arenaph = new TPlayerHandler(plugin,this);
		TCountDown = new TCountdown(TeamDeathMatchMain, this);
		arenafile = new File(plugin.getDataFolder()+File.separator+"/TeamDeathMatch/Arenas"+File.separator+arenaname+".yml");
		Teamdeathmatchmain.pdata.putArenaInHashMap(this);
	}
