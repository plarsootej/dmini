...
public class TWandTool {
	...
	private static int wandtoolid = ConfigHandler.MainTDM.getInt("Wand-Tool-ID");
		...
		if(inhand.getType() == Material.getMaterial(wandtoolid)) {
			if(event.getAction() == Action.LEFT_CLICK_BLOCK) {
				...
				if(loc1.isEmpty()) {
					...
					player.sendMessage("§6[DS] §cPos #1 and #2 Selected! Type §f/tdm setup §c For more information");
				}
